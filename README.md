...
To run this application, you need to first clone or download the ‘how to rename and check the image size before inserting it into a blazor rich text editor component’ repository and then open it in Visual Studio 2019. Now, build and run your project to view the output.
